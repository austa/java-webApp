...
<body>
	 ...
	 <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tum Duyurular</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                         ...
                         <table class="table table-hover">
						      ...
						      <%
		                        	...
		                        	for(Duyuru d:duyurular) {
										...
										out.println("<td>");
										out.print("<a href='duyurugoruntuleservlet?id=" + d.getId() + "' class='btn btn-success'>Goruntule</a> &nbsp;");
										out.print("<a href='duyuruduzenleformservlet?id=" + d.getId() + "' class='btn btn-warning'>Duzenle</a> &nbsp;");
										out.print("<a href='duyurusilservlet?id=" + d.getId() + "' class='btn btn-danger'>Sil</a>");
										out.println("</td>");
										out.println("</tr>");
		                        	}			
								%>
