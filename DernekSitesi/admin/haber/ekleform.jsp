                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	<form action="<%=baseUrl %>/admin/haberekleservlet" method="post" enctype="multipart/form-data">
		                        ...
		                        <div class="form-group">
		                            ...
		                            <input class="form-control" name="baslik" placeholder="Lutfen Haber Basligini Giriniz" required>
		                        </div>
		                        <div class="form-group">
		                             <label>Haber</label>
