 ...
 */
@WebServlet("/admin/duyuruduzenleformservlet")
public class DuyuruDuzenleFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DuyuruDuzenleFormServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("/admin/duyuru/duzenleform.jsp").forward(request, response);
