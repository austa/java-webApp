				...
				<% for(Haber h : haberler){ %>
					<div class="col-md-4 col-sm-6">
						<div class="portfolio-item">
							...
							<% if(h.getResim().equals("null")) { %>
								<a href="page-portfolio-item.html"><img src="default/img/portfolio2.jpg" alt="Project Name"></a>
							<% }else { %>
								<a href="page-portfolio-item.html"><img src="images/<%=h.getResim() %>" alt="Project Name"></a>
							<% }%>
					...
					<div class="col-md-12">
						<div class="products-slider">
							...
							<div class="shop-item">
								<!-- Product Image -->
								<div class="image">
									<% if(d.getResim().equals("null")) { %>
										<a href="page-portfolio-item.html"><img src="default/img/portfolio2.jpg" alt="Project Name"></a>
									<% }else { %>
										<a href="page-portfolio-item.html"><img src="images/<%=d.getResim() %>" alt="Project Name"></a>
									<% }%>
								</div>
								<!-- Product Title -->
								<div class="title">
